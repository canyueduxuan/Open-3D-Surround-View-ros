...
CAR_LENGTH = 0.612  # Meters
CAR_WIDTH = 0.58   # Meters
DRAW_CAR_MASK = True # Whether to draw the car mask bounding box over the final BEV map
...
BOWL_FLAT_RECT_X = 0.306 # Meters from origin: Defines width of the central rectangular "flat ground" zone
BOWL_FLAT_RECT_Y = 0.29 # Meters from origin: Defines length of the central rectangular "flat ground" zone
BOWL_FLAT_MARGIN = 2.5 # Meters of additional flat radial padding extending outward from the central rectangle before sweeping upward
BOWL_STEEPNESS = 10.0   # Exponent/Multiplier for how fast the edges curve upwards

# Projection Mask Tuning
MASK_RADIUS_SCALE = 0.6  # > 1.0 reduces masking on edges, letting camera see wider
